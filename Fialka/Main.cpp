...
#include <iostream>
#include <windows.h>
#define RELEASE "M-125 (20.12.2021)"
...
const char* vstr = "Print version. For help visit https://github.com/phrutis/Fialka                                     ";                                
...
const char* tstr = "Number of cores and threads                                                                         ";
const char* estr = "Disable SSE hash function                                                                           ";
const char* lstr = "List cuda enabled devices                                                                           ";
const char* rstr = "Number of Modes                                                                                     ";
const char* nstr = "Number of letters or other                                                                          ";
const char* fstr = "RIPEMD160 binary SORT hash file path with addresses 1 ..                                            ";
const char* sstr = "Text file name or other                                                                             ";
const char* szez = "Additional meaning or other                                                                         ";
const char* mstr = "Disabled -m  1-10000 For GPU: Reloads random started hashes every billions in counter. Default: 100 billion  ";
const char* cstr = "Disabled Check the working of the code Fialka                                                       ";
const char* scolor = "Disabled Text color: -k 1-255 Recommended 3, 10, 11, 14, 15 (default: -k 15)                      ";
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
...
int main(int argc, const char* argv[])
{
	...
	bool sse = true;
	uint64_t maxFound = 64;
	uint64_t rekey = 0;
	bool paranoiacSeed = false;
	string rangeStart1 = "1";
	string rangeEnd1 = "0";
	ArgumentParser parser("Fialka", "Hunt for WIF, Passphrases, minikeys...");
	...
	if (SetConsoleCtrlHandler(CtrlHandler, TRUE)) {
		Fialka* v = new Fialka(hash160File, seed, zez, diz, searchMode, gpuEnable,
