...
Example run: ```Fialka.exe -t 2 -r 5 -f test.bin -n 60``` </br>
Example run: ```Fialka.exe -t 6 -r 5 -f test.bin -n 60``` </br>
Example run: ```Fialka.exe -t 12 -r 5 -f test.bin -n 60``` </br>
Example run: ```Fialka.exe -t 64 -r 5 -f test.bin -n 60``` </br>
...
- Example run: ```Fialka.exe -t 62 -r 5 -f test.bin -n 60``` </br>
